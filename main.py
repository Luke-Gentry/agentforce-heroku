...
@app.post(
    ...
    description="Send a natural language message to Salesforce's Agentforce Apex REST endpoint. The response will be generated by the Agentforce AI agent. This endpoint can handle various CRM requests including retrieving events and meetings associated with accounts."
)
def call_agentforce(
    msg: Message,
